...
APP_VERSION = "v12.1-render-port-fix"
...
if __name__ == "__main__":
    start_scheduler()
    # Render's web service expects the container to bind to an externally
    # reachable port. Use 10000 explicitly to avoid Docker ENV/fallback
    # mismatches that can cause Render's port scan to time out.
    port = 10000
    print(f"Starting TPN dashboard on 0.0.0.0:{port}", flush=True)
